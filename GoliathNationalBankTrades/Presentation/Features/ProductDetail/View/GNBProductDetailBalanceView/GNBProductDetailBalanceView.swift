...
extension GNBProductDetailBalanceView {
    ...
    private func setupProductNameLabel() {
        ...
        productNameLabel.accessibilityIdentifier = AccessibilityIdentifiers.productNameLabel
    ...
    private func setupTotalBalanceLabel() {
        ...
        totalBalanceLabel.accessibilityIdentifier = AccessibilityIdentifiers.totalBalanceLabel
